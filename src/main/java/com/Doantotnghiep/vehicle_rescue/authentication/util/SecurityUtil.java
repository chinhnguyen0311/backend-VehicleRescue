package com.Doantotnghiep.vehicle_rescue.authentication.util;
...
public class SecurityUtil {
    ...
    @Value("${vehicle-rescue.jwt.base64-secret}")
    ...
    public String createAccessToken(String username, LoginResponseDTO.AccountInfo dto) {
    ...
    public String createRefreshToken(String username, LoginResponseDTO dto) {
        Instant now = Instant.now();
